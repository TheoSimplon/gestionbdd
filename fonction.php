...
function getalltitle(){
	...
	$requete = 
	'SELECT  DISTINCT videogames.id, Title, ReleaseDate, platform.name, publishers.name, developers.name, genres.name   
	FROM videogames
 ...
 */
function getBdd() {
    return new PDO("mysql:host=localhost;dbname=videogames;charset=utf8",
        "root", "",
